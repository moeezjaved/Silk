  ...
  return {
    ...
    layers: [
      ...
      },
      {
        ...
        startFrame: 0, endFrame: 150, src: `https://picsum.photos/seed/${t.id}/800/800`, fit: 'cover', radius: 24,
      },
      {
        id: 'headline', name: 'Headline', type: 'text',
        x: 90, y: 300, width: 900, height: 240, rotation: 0, opacity: 1,
        startFrame: 0, endFrame: 150, text: t.headline, fontSize: 150, fontWeight: 900,
      ...
      },
      {
        ...
        startFrame: 0, endFrame: 150, text: t.sub, fontSize: 46, fontWeight: 600,
